...
public class ScriptRunner {
    ...
    private static void writeExampleScripts() throws IOException {
        writeIfMissing("examples/hello_world.py", String.join("\n",
            ...
            "",
            "# ── Hello World ─────────────────────────────────────────────",
            "# Shows your position, health, and nearby entities.",
            "# Great first script to verify everything is working.",
            "",
            "x, y, z = pos()",
        ...
        writeIfMissing("examples/auto_eat.py", String.join("\n",
            ...
            "",
            "# ── Auto Eat ─────────────────────────────────────────────────",
            "# Automatically eats food when your hunger drops.",
            "# Add food to your inventory and run this in the background.",
            "",
        ...
        writeIfMissing("examples/auto_mine.py", String.join("\n",
            ...
            "",
            "# ── Auto Mine ────────────────────────────────────────────────",
            "# Uses Baritone to automatically find and mine ore.",
        ...
        writeIfMissing("examples/follow_on_command.py", String.join("\n",
            ...
            "",
            "# ── Follow On Command ────────────────────────────────────────",
            "# Watch chat. When a player says 'follow me', start following them.",
            "# Say 'stop following' in chat to stop.",
            "# Requires: Baritone mod (modrinth.com/mod/baritone)",
            "",
        ...
        writeIfMissing("examples/api_server.py", String.join("\n",
            ...
            "# (phone, dashboard, another script) can control Minecraft.",
            "#",
        ...
        Files.writeString(SCRIPTS_DIR.resolve("examples/armor_hud.py"), String.join("\n",
            ...
            "",
            "# ── Armor HUD ─────────────────────────────────────────────────────────────────",
            "# Vertical armor overlay on the right side — item icons + durability bars.",
            "# Head at top, boots at bottom. Stop the script to remove the overlay.",
            "",
            "SLOTS = [",
            "    'armor_head',",
            "    'armor_chest',",
        ...
        writeIfMissing("examples/welcome_bot.py", String.join("\n",
            ...
            "# The greeting goes to public chat so the joining player actually sees it.",
            "# For bots that respond only to you, see chat_bot.py which uses msg() instead.",
            "",
        ...
        Files.writeString(SCRIPTS_DIR.resolve("examples/hud_basics.py"), String.join("\n",
            ...
            "",
            "# ── HUD Basics ────────────────────────────────────────────────────────────────",
            "# Introduction to the HUD overlay system.",
            "# Read this before looking at armor_hud.py — it covers all 5 widget types.",
            "# Stop this script to remove the overlay.",
            "#",
            "# WIDGET TYPES:",
        ...
        Files.writeString(SCRIPTS_DIR.resolve("examples/health_monitor.py"), String.join("\n",
            ...
            "",
            "# ── Health Monitor ────────────────────────────────────────────────────────────",
            "# Background watcher — warns you when things go wrong.",
            "# Leave this running. It does nothing until it needs to alert you.",
            "#",
            "# This script demonstrates the core Peripheral pattern:",
            "#   1. Run forever with wait()",
            "#   2. Read state() each tick",
            "#   3. Compare to previous state to detect changes",
            "#   4. React with msg() or say()",
            "#",
            "# Pair with auto_eat.py for complete passive survival coverage.",
            "#",
            "# ── What it watches ──────────────────────────────────────────────────────────",
            "#   Low health       warns once, re-warns if health drops further",
            "#   Low hunger       warns once",
            "#   Creeper nearby   warns immediately",
            "#   Night arriving   single alert on day -> night transition",
            "#   Death            tells you your death coordinates",
            "",
        ...
        Files.writeString(SCRIPTS_DIR.resolve("examples/chat_bot.py"), String.join("\n",
            ...
            "",
            "# ── Chat Command Bot ──────────────────────────────────────────────────────────",
            "# Watches chat for . commands and responds with live game data.",
            "# Leave this running in the background.",
            "#",
            "# Responses use msg() — they appear only in YOUR client chat, not public chat.",
            "# See welcome_bot.py for an example that responds publicly with say().",
            "#",
            "# Commands:",
            "#   .help              list all commands",
            "#   .pos               show your current coordinates",
            "#   .health            show health and hunger",
            "#   .time              show in-game time and weather",
            "#   .inv               list your inventory",
            "#   .weather           fetch real-world weather (Open-Meteo, no key needed)",
            "#   .mobs              list nearby hostile mobs",
            "#",
            "# You can extend this — just add more elif branches below.",
            "",
        ...
        writeIfMissing("examples/clickable_links.py", String.join("\n",
            ...
            "# Shows how to send messages with clickable URLs, clickable commands,",
            "# and hover-text into Minecraft chat using rich_msg().",
            "",
        ...
        writeIfMissing("examples/custom_gui.py", String.join("\n",
            ...
            "",
            "# ── Custom In-Game GUI ────────────────────────────────────────────────────────",
            "# Opens a real Minecraft screen built from Python.",
            "# Press H in-game to open/close at any time.",
            "# Run this in the background — it keeps the data fresh.",
            "",
            "open_gui({",
            "    'title': 'Player Stats',",
            "    'w': 260,",
        ...
        writeIfMissing("examples/weather_display.py", String.join("\n",
            ...
            "# Fetches live weather and shows it in-game.",
        ...
        writeIfMissing("examples/web_dashboard.py", String.join("\n",
            ...
            "",
            "# ── Browser Dashboard ─────────────────────────────────────────────────────────",
            "# Starts a local web server. Open http://localhost:25587/ in any browser",
            "# to see your live game state and send commands.",
            "#",
            "# Endpoints:",
            "#   GET  /              HTML dashboard (auto-refreshes every 2s)",
            "#   GET  /api/state     JSON: position, health, hunger, etc.",
            "#   GET  /api/inventory JSON: inventory slots",
            "#   POST /api/say       {\"message\": \"hello\"} sends chat",
            "#   POST /api/goto      {\"x\": 100, \"z\": -200} walks there",
            "",
            "PORT = 25587",
